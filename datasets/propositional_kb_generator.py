...
def generate_kb(n_roots, avg_root_size, avg_root_similarity, deviation, avg_tree_depth, avg_branching_factor, removal_probability):
    all_premises = generate_premises(n_roots, avg_tree_depth, avg_branching_factor) # ASSUMPTION: Each root rule has 1 to 4 premises.
    roots = root_generator(n_roots, avg_root_size, avg_root_similarity, all_premises)
    kb = []
    for root in roots:
...
if __name__ == '__main__':
    ...
    removal_probaability = 0.1
    kb = generate_kb(n_roots, avg_root_size, avg_root_similarity, deviation, avg_tree_depth, avg_branching_factor, removal_probaability)
